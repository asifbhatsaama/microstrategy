let url = "https://demo.microstrategy.com/MicroStrategyLibrary/app/B7CA92F04B9FAE8D941C3E9B7E0CD754/14CC30F611EAEC3D273F0080EFD5628A/K53--K46";
...
async function runCode1() {
  ...
  config = {
    url: url,
    placeholder: document.getElementById("embedding-dossier-container1"),
  ...
  config.visualizationAppearances = [
    {
      visualizationKey: "W65", // Replace with visualization key in your dossier
      size: "maximized",
